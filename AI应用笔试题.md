...
在本次任务中，你需要借助 AI 工具（如  Claude Code / CodeX / Gemini CLI / Cursor 等），完成一个**最小可用版本（MVP）**的系统。**并且需要研究Harness Engineering的思想，通过使用开源或者自建Harness框架，来实现以上的mvp系统，并且沉淀agent.md，hook，skills等内容**
